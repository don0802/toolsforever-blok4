...
if (isset($_GET['id'])) {
    $tool_id = $_GET['id'];
    $sql = "SELECT * FROM tools WHERE tool_id = '" . mysqli_real_escape_string($conn, $tool_id) . "'";
            ...
            <div class="product-detail">
                <div class="row">
                    ...
                    <div class="col">
                        ...
                        <p><?php echo htmlspecialchars($tool['tool_brand']) ?></p>
                        <p><?php echo htmlspecialchars($tool['tool_category']) ?></p>
                        <p>€ <?php echo number_format($tool['tool_price'] / 100, 2, ',', '') ?></p>
                        <p>
                            <a href="add_to_cart.php?id=<?php echo htmlspecialchars($tool['tool_id']); ?>" class="btn">Bestel</a>
                        </p>
                    </div>
                </div>
